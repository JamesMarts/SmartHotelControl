...
public class BleUtil {
    ...
    public static boolean refreshDeviceCache(BluetoothGatt gatt) {
        try {
            ...
            if (e != null) {
                ...
                L.i("BluetoothUtil", "Refreshing result: " + success);
                return success;
            }
        } catch (Exception var3) {
            L.e("BluetoothUtil", "An exception occured while refreshing device" + var3);
        }
        return false;
    }
    ...
    public static String parseResultDataToHex(BluetoothGattCharacteristic characteristic) {
        String data = null;
        try {
            data = DirectivesConvert.bytesToHexString(characteristic.getValue());
        } catch (Exception e) {
        }
        return data;
    }
